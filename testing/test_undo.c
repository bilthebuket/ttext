...
Test(editor, test_undo_complex2, .init = setup_state, .fini = teardown_state)
{
	...
	(*es.mode)(&es, 'u');
	expect_state("#include <stdio.h>\n\nint main(d)\n{\n    printf(test);\n}");
	ci_expect_state((const int[]) {8, MAGENTA_TEXT, 9, RED_TEXT, 3, BLUE_TEXT, 5, YELLOW_TEXT, 1, BLUE_TEXT, 9, YELLOW_TEXT,
					4, CYAN_TEXT, 1, YELLOW_TEXT, 1, RED_TEXT, 1, YELLOW_TEXT});

	(*es.mode)(&es, 'u');
	expect_state("#include <stdio.h>\n\nint main(id)\n{\n    printf(test);\n}");
	ci_expect_state((const int[]) {8, MAGENTA_TEXT, 9, RED_TEXT, 3, BLUE_TEXT, 5, YELLOW_TEXT, 2, BLUE_TEXT, 9, YELLOW_TEXT,
					4, CYAN_TEXT, 1, YELLOW_TEXT, 1, RED_TEXT, 1, YELLOW_TEXT});

	(*es.mode)(&es, 'u');
	expect_state("#include <stdio.h>\n\nint main(oid)\n{\n    printf(test);\n}");
	ci_expect_state((const int[]) {8, MAGENTA_TEXT, 9, RED_TEXT, 3, BLUE_TEXT, 5, YELLOW_TEXT, 3, BLUE_TEXT, 9, YELLOW_TEXT,
					4, CYAN_TEXT, 1, YELLOW_TEXT, 1, RED_TEXT, 1, YELLOW_TEXT});

	(*es.mode)(&es, 'u');
	expect_state("#include <stdio.h>\n\nint main(void)\n{\n    printf(test);\n}");
	ci_expect_state((const int[]) {8, MAGENTA_TEXT, 9, RED_TEXT, 3, BLUE_TEXT, 5, YELLOW_TEXT, 4, BLUE_TEXT, 9, YELLOW_TEXT,
					4, CYAN_TEXT, 1, YELLOW_TEXT, 1, RED_TEXT, 1, YELLOW_TEXT});

	(*es.mode)(&es, 'u');
	expect_state("#include <stdio.h>\n\nint main(void)\n{\n    printf();\n}");
	ci_expect_state((const int[]) {8, MAGENTA_TEXT, 9, RED_TEXT, 3, BLUE_TEXT, 5, YELLOW_TEXT, 4, BLUE_TEXT, 10, YELLOW_TEXT,
